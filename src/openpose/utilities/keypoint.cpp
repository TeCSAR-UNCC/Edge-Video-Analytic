...
namespace op
{
    ...
    template OP_API int getValidBBox(const Array<float>& keypoints, const int person, const float threshold, const int minKeypoint);
    template OP_API int getValidBBox(const Array<double>& keypoints, const int person, const double threshold, const int minKeypoint);
    /****************************************/
    /****************************************/
    /**************We edited above***********/
    /****************************************/
