...
$EDGE_ANALYTICS/build/examples/openpose/openpose.bin -image_dir $EDGE_ANALYTICS/testbed/data/DukeMTMC/frames/$CAMERA/ -render_pose 0 -keypoint_scale 3 -num_gpu 1 -write_json $EDGE_ANALYTICS/testbed/data/keypoints/ -display 0
