...
#from yolo_v3_2_objects import _conv2d_fixed_padding, _fixed_padding, _get_size, \
#    _detection_layer, _upsample
...
#added
def yolo_v3_tiny2(inputs, num_classes, is_training=False, data_format='NCHW', reuse=False):
    """
        ...
        with slim.arg_scope([slim.conv2d, slim.batch_norm, _fixed_padding], reuse=reuse):
            with slim.arg_scope([slim.conv2d],
                ...
                with tf.variable_scope('yolo-v3-tiny'):
                    ...
                    detect_1, feature_map1 = _detection_layer(
